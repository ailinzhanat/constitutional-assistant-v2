...
3) доверенность или иной документ о полномочиях представителя (если обращение подаётся
   представителем);
4) документы, подтверждающие полномочия представителя (удостоверение адвоката и письменное
   уведомление о защите — для адвоката; документ о членстве в палате юридических
   консультантов — для юридического консультанта);
